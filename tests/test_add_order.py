...
class TestAddOrder(TestCase):
    ...
    def test_add_order_short(self):
        # GIVEN
        message = AddOrderShort.from_parms(time_offset=27_000,
                                           order_id='ORID0001',
                                           side='B',
                                           quantity=20_000,
                                           symbol='AAPL',
    ...
    def test_add_order_expanded(self):
        # GIVEN
        message = AddOrderExpanded.from_parms(time_offset=99_000,
                                              order_id='ORID0991',
                                              side='S',
                                              quantity=20_000,
                                              symbol='AAPL',
        ...
        assert_that(msg_bytes, is_(compare_bytes(bytearray([
            41,  # Length
            0x2F,  # Type
            0xb8, 0x82, 1, 0,  # Time offset
            0x4f, 0x52, 0x49, 0x44, 0x30, 0x39, 0x39, 0x31,  # Order Id
            0x53,  # Side Indicator
            0x20, 0x4E, 0, 0,  # Quantity
            0x41, 0x41, 0x50, 0x4c, 0x20, 0x20, 0x20, 0x20,  # Symbol
            0x5A, 0x23, 0, 0, 0, 0, 0, 0,  # Price
            0x01,  # AddFlags
            0x4d, 0x50, 0x49, 0x44,  # ParticipantId
    ...
    def test_add_order_long_parse(self):
        ...
        msg_bytes = bytearray([
            ...
            0x42,  # Side Indicator
            0x20, 0x4E, 0, 0,  # Quantity
            0x41, 0x20, 0x20, 0x20, 0x20, 0x20,  # Symbol
            0x5A, 0x23, 0, 0, 0, 0, 0, 0,  # Price
            0x01  # AddBitField
        ])
    ...
    def test_add_order_short_parse(self):
        ...
        msg_bytes = bytearray([
            26,  # Length
            0x22,  # Type
            0x08, 0xEA, 1, 0,  # Time offset
            0x4f, 0x52, 0x49, 0x44, 0x30, 0x30, 0x30, 0x32,  # Order Id
            0x42,  # Side Indicator
            0x20, 0x4E,  # Quantity
            0x41, 0x41, 0x50, 0x4c, 0x20, 0x20,  # Symbol
            0x5A, 0x23,  # Price
