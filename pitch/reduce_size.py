...
class ReduceSizeLong(ReduceSizeBase):
    ...
    def from_parms(
            time_offset: int,
            order_id: str,
            canceled_quantity: int) -> 'ReduceSizeLong':
        reduce_size_long = ReduceSizeLong()
        reduce_size_long.set_fields(time_offset=time_offset,
                                    order_id=order_id,
...
class ReduceSizeShort(ReduceSizeBase):
    ...
    def from_parms(
            time_offset: int,
            order_id: str,
            canceled_quantity: int) -> 'ReduceSizeShort':
        reduce_size_short = ReduceSizeShort()
        reduce_size_short.set_fields(time_offset=time_offset,
                                     order_id=order_id,
                                     canceled_quantity=canceled_quantity)
