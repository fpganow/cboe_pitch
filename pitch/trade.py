...
class TradeLong(TradeBase):
    ...
    def from_parms(time_offset: int,
                   ...
                   symbol: str,
                   price: float,
                   execution_id: str) -> 'TradeLong':
        trade_long = TradeLong()
        trade_long.set_fields(time_offset=time_offset,
                              order_id=order_id,
                              side=side,
                              quantity=quantity,
                              symbol=symbol,
...
class TradeShort(TradeBase):
    ...
    def from_parms(time_offset: int,
        ...
        trade_short.set_fields(time_offset=time_offset,
                               order_id=order_id,
                               side=side,
                               quantity=quantity,
                               symbol=symbol,
...
class TradeExpanded(TradeBase):
    ...
    def from_parms(time_offset: int,
                   ...
                   symbol: str,
                   price: float,
                   execution_id: str) -> 'TradeExpanded':
        trade_expanded = TradeExpanded()
        trade_expanded.set_fields(time_offset=time_offset,
                                  order_id=order_id,
                                  side=side,
                                  quantity=quantity,
                                  symbol=symbol,
