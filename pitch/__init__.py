...
def get_add_order_short(parameters) -> List[int]:
    ...
    symbol = getattr(parameters, 'Symbol')
    price = getattr(parameters, 'Price')
    msg_bytes = AddOrderShort.from_parms(time_offset=time_offset,
                                         order_id=order_id,
                                         side=side,
                                         quantity=quantity,
                                         symbol=symbol,
...
def get_add_order_expanded(parameters) -> List[int]:
    ...
    msg_bytes = AddOrderExpanded.from_parms(time_offset=time_offset,
                                            order_id=order_id,
                                            side=side,
                                            quantity=quantity,
                                            symbol=symbol,
                                            ...
                                            customer_indicator=customer_indicator).get_bytes()
    return list(msg_bytes)
...
def get_reduce_size_long(parameters) -> List[int]:
    ...
    msg_bytes = ReduceSizeLong.from_parms(time_offset=time_offset,
                                          order_id=order_id,
                                          canceled_quantity=canceled_quantity).get_bytes()
...
def get_reduce_size_short(parameters) -> List[int]:
    ...
    msg_bytes = ReduceSizeShort.from_parms(time_offset=time_offset,
                                           order_id=order_id,
                                           canceled_quantity=canceled_quantity).get_bytes()
...
def get_modify_order_long(parameters) -> List[int]:
    ...
    msg_bytes = ModifyOrderLong.from_parms(time_offset=time_offset,
                                           order_id=order_id,
                                           quantity=quantity,
                                           price=price).get_bytes()
...
def get_modify_order_short(parameters) -> List[int]:
    ...
    msg_bytes = ModifyOrderShort.from_parms(time_offset=time_offset,
                                            order_id=order_id,
                                            quantity=quantity,
                                            price=price).get_bytes()
...
def get_delete_order(parameters) -> List[int]:
    ...
    msg_bytes = DeleteOrder.from_parms(time_offset=time_offset,
                                       order_id=order_id).get_bytes()
...
def get_trade_long(parameters) -> List[int]:
    ...
    msg_bytes = TradeLong.from_parms(time_offset=time_offset,
                                     order_id=order_id,
                                     side=side,
                                     quantity=quantity,
                                     symbol=symbol,
...
def get_trade_short(parameters) -> List[int]:
    ...
    msg_bytes = TradeShort.from_parms(time_offset=time_offset,
                                      order_id=order_id,
                                      side=side,
                                      quantity=quantity,
                                      symbol=symbol,
...
def get_trade_expanded(parameters) -> List[int]:
    ...
    msg_bytes = TradeExpanded.from_parms(time_offset=time_offset,
                                         order_id=order_id,
                                         side=side,
                                         quantity=quantity,
                                         symbol=symbol,
...
def get_order_executed_at_price_size(parameters) -> List[int]:
    ...
    msg_bytes = OrderExecutedAtPriceSize.from_parms(time_offset=time_offset,
                                                    order_id=order_id,
                                                    executed_quantity=executed_quantity,
